class cfgGroups
{
	class West
	{
		class CPC_B_DAM
		{
			name = "République du Damuz";
			class Infantry
			{
				name = "Infantry";
				class CPC_B_DAM_InfantrySquad
				{
					name = "Infantry Squad";
					icon = "\A3\ui_f\data\map\markers\nato\o_inf.paa";
					faction = "CPC_B_DAM"; side = 1;
					rarityGroup = 0.7;
					class Unit0
					{
						side = 1;
			...
			class Motorized
			{
				...
				class CPC_B_DAM_MotorizedInfantrySquad
				{
					...
					{
						side = 1;
						vehicle = "CPC_ME_B_DAM_M998_2dr_fulltop"; 
						rank = "CORPORAL";
						position[] = {-5,0,0};
					};
					class Unit2
				...
				class CPC_B_DAM_MotorizedReconSection
				{
				...
				class CPC_B_DAM_MotorizedPatrol
				{
			...
			class Mechanized
			{
				...
				class CPC_B_DAM_MechanizedInfantrySquadM113
				{
				...
				class CPC_B_DAM_MechanizedInfantrySquadBTR70
				{
					name = "Mechanized Infantry Squad (BTR70)";
					icon = "\A3\ui_f\data\map\markers\nato\o_mech_inf.paa";
					faction = "CPC_B_DAM";
					rarityGroup = 0.9;
					side = 1;
				...
				class CPC_B_DAM_MechanizedReconSection
				{
					...
					{
						side = 1;
						vehicle = "CPC_ME_B_DAM_soldier_AMG";
						rank = "CORPORAL";
						position[] = {7,0,0};
					};
					class Unit5
    ...
    class East
    {
        class CPC_O_KAM
		{
			...
			{
				name = "Infantry";
				class CPC_O_KAM_InfantrySquad
				{
					name = "Infantry Squad";
					icon = "\A3\ui_f\data\map\markers\nato\o_inf.paa";
					faction = "CPC_O_KAM"; side = 0;
					rarityGroup = 0.7;
					class Unit0
					{
						side = 0;
			...
			{
				name = "Motorized Infantry";
				class CPC_O_KAM_MotorizedInfantrySquad
				{
					name = "Motorized Infantry Squad";
					icon = "\A3\ui_f\data\map\markers\nato\o_motor_inf.paa";
					faction = "CPC_O_KAM";
				...
				class CPC_O_KAM_MotorizedReconSection
				{
					name = "Motorized Recon Section";
					icon = "\A3\ui_f\data\map\markers\nato\o_motor_inf.paa";
					faction = "CPC_O_KAM";
					...
					{
						side = 0;
						vehicle = "CPC_ME_O_KAM_uaz_dshkm";
						rank = "CORPORAL";
						position[] = {-5,0,0};
					};
					class Unit2
				...
				class CPC_O_KAM_MotorizedPatrol
				{
					name = "Motorized Patrol";
					icon = "\A3\ui_f\data\map\markers\nato\o_motor_inf.paa";
					faction = "CPC_O_KAM";
			...
			{
				name = "Mechanized Infantry";
				class CPC_O_KAM_MechanizedInfantrySquadBMP1
				{
				...
				class CPC_O_KAM_MechanizedInfantrySquadBTR80
				{
					name = "Mechanized Infantry Squad (BTR80)";
					icon = "\A3\ui_f\data\map\markers\nato\o_mech_inf.paa";
					faction = "CPC_O_KAM";
					rarityGroup = 0.9;
					side = 0;
				...
				class CPC_O_KAM_MechanizedReconSection
				{
					name = "Mechanized Recon Section";
					icon = "\A3\ui_f\data\map\markers\nato\o_mech_inf.paa";
					faction = "CPC_O_KAM";
	...
	class Indep
	{
		class CPC_I_REB
		{
			...
			{
				name = "Infantry";
				class CPC_I_REB_InfantrySquad
				{
					name = "Infantry Squad";
					icon = "\A3\ui_f\data\map\markers\nato\o_inf.paa";
					faction = "CPC_I_REB"; side = 2;
					rarityGroup = 0.7;
					class Unit0
					{
						side = 2;
			...
			{
				name = "Motorized Infantry";
				class CPC_I_REB_MotorizedInfantrySquad
				{
					name = "Motorized Infantry Squad";
					icon = "\A3\ui_f\data\map\markers\nato\o_motor_inf.paa";
					faction = "CPC_I_REB";
				...
				class CPC_I_REB_MotorizedReconSection
				{
					name = "Motorized Recon Section";
					icon = "\A3\ui_f\data\map\markers\nato\o_motor_inf.paa";
					faction = "CPC_I_REB";
					...
					{
						side = 2;
						vehicle = "CPC_ME_I_REB_uaz_dshkm";
						rank = "CORPORAL";
						position[] = {-5,0,0};
					};
					class Unit2
				...
				class CPC_I_REB_MotorizedPatrol
				{
					name = "Motorized Patrol";
					icon = "\A3\ui_f\data\map\markers\nato\o_motor_inf.paa";
					faction = "CPC_I_REB";
